...
// funcao para embaralhar um array de cursos com o algoritmo de fisher-yates
void shuffle_courses(Course *courses, int num_courses);
// funcao que calcula o tempo de inserção
